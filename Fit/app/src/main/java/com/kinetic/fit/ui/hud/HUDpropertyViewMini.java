...
@EView
public class HUDpropertyViewMini extends HUDPropertyView {


    @ViewById(R.id.hud_property_mini_image)
    ImageView mPropertyImage;

    @ViewById(R.id.hud_property_mini_value)
    TextView mPropertyValue;

    private FitProperty mProperty = FitProperty.None;

    public HUDpropertyViewMini(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void changeTimer(long t) {
        mPropertyValue.setText(t + "");
    }
    ...
    public void updateValue(SessionController.SessionControllerBinder sc, SensorValues svs) {
        ...
        switch (mProperty) {
            ...
            case HeartRateLapPercentageMaxAverage:
                mPropertyValue.setText(mProperty.getStringValue(sc.getCurrentLap().getAvgHeartRateMaxPercent(), "%d"));
                break;
            case HeartRateLapPercentageReserveAverage:
                mPropertyValue.setText(mProperty.getStringValue(sc.getCurrentLap().getAvgHeartRateReservePercent(), "%d"));
                break;
            case HeartRatePercentageMax:
                mPropertyValue.setText(mProperty.getStringValue(sc.getCurrentDataSlice().currentHeartRateMaxPercent, "%d"));
                break;
            case HeartRatePercentageMaxAverage:
                mPropertyValue.setText(mProperty.getStringValue(sc.getSession().getAvgHeartRateMaxPercent(), "%d"));
                break;
            case HeartRatePercentageReserve:
                mPropertyValue.setText(mProperty.getStringValue(sc.getCurrentDataSlice().currentHeartRateReservePercent, "%d"));
                break;
            case HeartRatePercentageReserveAverage:
                mPropertyValue.setText(mProperty.getStringValue(sc.getSession().getAvgHeartRateReservePercent(), "%d"));
                break;
            ...
            case PowerPercentageFTP:
                mPropertyValue.setText(mProperty.getStringValue(sc.getCurrentDataSlice().currentPowerPercentageFTP, "%.2f"));
                break;
            case PowerTarget:
    ...
    public void setTextSize(int sizeInSp){
        mPropertyValue.setTextSize(sizeInSp);
    }
}
