...
public class YouTubeCastPresentation extends FitCastPresentation implements YouTubePlayer.OnInitializedListener {
    ...
    public YouTubeCastPresentation(Context context, Display display) {
        super(context, display);
    }

    YouTubePlayerFragment ytFrag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yt_cast_presentation);

        ytFrag = YouTubePlayerFragment.newInstance();
    ...
    protected void onStart() {
        VideoControllerItem video = videoController.getVideo();
            if (video.uri != null) {
                ytFrag.initialize(YOUTUBE_API_KEY, this);
            }
    }
...
//            videoPlayer.pause(YOUTUBE_API_KEY, this);
        }
    }
    ...
    void sessionTick(SessionController.SessionControllerBinder controller, double timeDelta) {
        ...
        if (controller.getState() == SessionController.SessionState.Workout) {
//            videoPlayer.start();
        }
...
//        }
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        youTubePlayer.cueVideo(videoController.getVideo().youTubeId);
        youTubePlayer.play();
    }
